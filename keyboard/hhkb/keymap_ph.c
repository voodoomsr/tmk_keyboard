...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = \
    KEYMAP(CAPS, FN6, FN7,   F3,   F4,   F5,   F6,   F7,   F8,   F9,   F10,  F11, F12, F1, F2, \
    ...
    [3] = \
    KEYMAP(TRNS, PGDN, PGUP,  HOME,  END,  TRNS,  TRNS,  TRNS,  TRNS,  TRNS,  TRNS, TRNS, TRNS, TRNS, TRNS, \
    ...
    KEYMAP(TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS,    TRNS, \
		...
		[5] = \
    KEYMAP(TRNS, F1,  F2,  F3,  F4,  F5,  F6,  F7,  TRNS ,  TRNS, BSPC, TRNS, F12, INS, FN3, \
           TRNS, NO,  NO,  NO,  NO,  NO,    NO,   7,  8,   9,   TRNS,   TRNS, TRNS,   BSPC,  \
           TRNS, NO,  NO,  NO,  NO,  NO,   MINS,   4,  5,   6,   FN21,  TRNS,  ENTER, \ 
           TRNS, NO,  NO,  NO,  NO,  TRNS,  TRNS,   1,  2,   3,   TRNS,   TRNS, TRNS, \ 
                TRNS,TRNS,         0,               TRNS      ,  FN0),
